...
public class KombinleriListeleActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    public RecyclerKombinleriListeleAdapter recyclerAdapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kombinleri_listele);


        recyclerView = findViewById(R.id.recyclerKombinListe);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerAdapter = new RecyclerKombinleriListeleAdapter(MainActivity.kombinList.size());
